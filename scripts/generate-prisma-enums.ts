 ...
 */
function generateZodEnums(enums: EnumDefinition[]): string {
  const imports = `/**
 * Prisma Enums - Auto-generated from Prisma schema
 *
 * DO NOT EDIT THIS FILE MANUALLY!
 *
 * This file is auto-generated by scripts/generate-prisma-enums.ts
...
function main() {
  ...
  console.log('   Enums:', enums.map((e: EnumDefinition) => e.name).join(', '));
}
